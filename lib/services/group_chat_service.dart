...
class GroupChatService {
  ...
  static Future<void> _checkAndCreateDefaultDocument() async {
    try {
      DocumentReference docRef = _firestore.collection('groupChats').doc(defaultGroupChatDocId);
      ...
      if (!docSnapshot.exists) {
        ...
        const imageUrl = "https://upload.wikimedia.org/wikipedia/sco/4/47/FC_Barcelona_%28crest%29.svg";
...
//TODO work on this
  ...
  static Future<String> createNewGroup(String name, String description, String imageUrl) async {
    try {
